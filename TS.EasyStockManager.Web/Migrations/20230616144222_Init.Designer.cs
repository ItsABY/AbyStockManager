            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Barcode = "EX01",
                            CreateDate = new DateTime(2023, 6, 17, 0, 42, 21, 817, DateTimeKind.Local).AddTicks(6833),
                            Price = 1m,
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 17, 0, 42, 21, 817, DateTimeKind.Local).AddTicks(4547),
                            StoreCode = "EX01",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 17, 0, 42, 21, 800, DateTimeKind.Local).AddTicks(4455),
                            TransactionTypeName = "Stock Receipt"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 6, 17, 0, 42, 21, 803, DateTimeKind.Local).AddTicks(8966),
                            TransactionTypeName = "Stock Out"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 6, 17, 0, 42, 21, 803, DateTimeKind.Local).AddTicks(8994),
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 17, 0, 42, 21, 805, DateTimeKind.Local).AddTicks(1895),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 6, 17, 0, 42, 21, 805, DateTimeKind.Local).AddTicks(2103),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 6, 17, 0, 42, 21, 805, DateTimeKind.Local).AddTicks(2109),
                            Isocode = "m",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 17, 0, 42, 21, 817, DateTimeKind.Local).AddTicks(2082),
